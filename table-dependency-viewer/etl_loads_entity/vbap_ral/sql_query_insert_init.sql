...
select
    ...
    tech_etl.util_text_to_null_validation("ZZLFPOSNR") as zzlfposnr,						-- Позиция поставки
    tech_etl.util_text_to_null_validation("ZZLFVBELN") as zzlfvbeln							-- Поставка переработчика
from stg."VBAP" v
...
where "MANDT" = '400'; 
--and case when "AEDAT"='00000000' then "ERDAT" else "AEDAT" end >='20220101';