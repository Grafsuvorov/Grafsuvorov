drop table if exists ods."/rusal/shipdata_ral" cascade;
...
comment on column ods."/rusal/shipdata_ral".traty is 'Вид транспортного средства | Вид транспортного средства | stg."/RUSAL/SHIPDATA"."TRATY"';
