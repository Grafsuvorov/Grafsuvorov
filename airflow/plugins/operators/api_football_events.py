...
class FetchMatchEventsOperator(BaseOperator):
    ...
    @staticmethod
    def _get_missing_fixture_ids_for_season(engine: Engine, season: int) -> List[int]:
        """
        ...
        sql = text(
            ...
            JOIN last_season ls ON s.season = ls.season
    ...
    def execute(self, context: Context):
        ...
        log_id = log_start(
            ...
            operation="insert_missing_last_season",
            extra=None,
        )
        ...
        try:
            ...
            fixture_ids = self._get_missing_fixture_ids_for_season(engine, last_season)
            self.log.info("Last season=%s, missing fixtures to load events: %s",
                          last_season, len(fixture_ids))
