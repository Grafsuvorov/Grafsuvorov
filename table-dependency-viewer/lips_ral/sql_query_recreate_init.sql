drop table if exists ods.lips_ral CASCADE;

create table if not exists ods.lips_ral (
...
comment on column ods.lips_ral.sobkz is 'Код особого запаса | Код особого запаса | LIPS.SOBKZ';
comment on column ods.lips_ral.vbelv is 'Документ сбыта, инициирующий | Документ сбыта, инициирующий | LIPS.VBELV';
comment on column ods.lips_ral.posnv is 'Инициирующая позиция | Инициирующая позиция | LIPS.POSNV';
