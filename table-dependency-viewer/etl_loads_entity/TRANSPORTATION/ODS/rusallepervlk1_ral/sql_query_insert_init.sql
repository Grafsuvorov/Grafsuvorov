insert into ods."/rusal/lepervlk1_ral"
(id, pos, type_load, numvag, numnakl, weightnet, regdate, senddate, cartare, type_vagon, zterminal, genaktdate, delivery_in, knote, knote1, knote2, werks_from, 
werks_to, matnr, vehicle, conosnum, dock_knote, erdat, erzet, ernam, aedat, aezet, aenam, type_prod)
