...
create table if not exists ods.ekpo_ral
(
...
comment on column ods.ekpo_ral."packno" is 'Номер пакета | Номер пакета | EKPO.PACKNO';
...
comment on column ods.ekpo_ral."zzzone" is 'Зона склада | Зона склада | EKPO.ZZZONE';
comment on column ods.ekpo_ral.brtwr is 'Стоимость заказа брутто в валюте заказа | Стоимость заказа брутто в валюте заказа | EKPO.BRTWR';
