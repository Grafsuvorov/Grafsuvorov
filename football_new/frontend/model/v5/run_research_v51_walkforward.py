...
from frontend.model.v4.ml_base import fit_catboost_base, predict_catboost_base
...
OUTPUT_PATH = Path("tmp/outcome_v5_1_walkforward.json")
...
def main() -> None:
    ...
    while True:
        ...
        model_v4 = fit_catboost_base(tr, cal)
        probs_v4 = predict_catboost_base(model_v4, val)

        model_v5 = fit_catboost_v5(tr, cal)
        probs_v5 = predict_catboost_v5(model_v5, val)
        ...
        windows.append(
            {
                ...
                "overall": {
                    ...
                    "v4_1_base": evaluate_probs(val, probs_v4, "v4_1_base"),
                    "v5_0_catboost": evaluate_probs(val, probs_v5, "v5_0_catboost"),
                },
            }
        )
        val_end = val_end - timedelta(days=STEP_DAYS)
    ...
    report = {
        ...
        "aggregate": {
            ...
            "v4_1_base": _aggregate("v4_1_base"),
            "v5_0_catboost": _aggregate("v5_0_catboost"),
        },
    }
