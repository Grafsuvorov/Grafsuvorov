order-breaches:1   Failed to load resource: the server responded with a status of 404 (Not Found)

http://localhost:8000/api/order-breaches
...
def get_order_breaches():
    rows = get_dependency_violations()
