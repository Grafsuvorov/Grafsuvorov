...
comment on column ods."/rusal/lemps_ral".nkont is '№ контейнера в который перегружается вагон | № контейнера в который перегружается вагон | /RUSAL/LEMPS.NKONT';
