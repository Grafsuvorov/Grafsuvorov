...
YTRACK_API_URL = os.getenv("YTRACK_API_URL", "https://api.tracker.yandex.net/v3")
YTRACK_OAUTH_TOKEN = os.getenv("YTRACK_OAUTH_TOKEN", "")
YTRACK_ORG_ID = os.getenv("YTRACK_ORG_ID", "")
YTRACK_CLOUD_ORG_ID = os.getenv("YTRACK_CLOUD_ORG_ID", "")
YTRACK_QUEUE = os.getenv("YTRACK_QUEUE", "")
YTRACK_ISSUE_TYPE = os.getenv("YTRACK_ISSUE_TYPE", "task")
YTRACK_SSL_VERIFY = os.getenv("YTRACK_SSL_VERIFY", "true")
