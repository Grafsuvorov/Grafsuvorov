...
(id, pos, container, numnakl, carnumber, oper_code, oper_date, oper_time, load_station, erdat, erzet, ernam, aedat, aezet, aenam, oper_station, dest_station)
...
select
	...
	tech_etl.util_text_to_null_validation("OPER_STATION") as oper_station,
	tech_etl.util_text_to_null_validation("DEST_STATION") as dest_station
