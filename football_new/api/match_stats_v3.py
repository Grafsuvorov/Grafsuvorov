    ...
    try:
        ...
        WITH base AS (
          SELECT
            ...
            to_char(s.date AT TIME ZONE 'UTC', 'DD.MM HH24:MI') AS datetime,
        ...
        SELECT
          b.fixture_id, b.date, b.league, b.season,
          b.round_label,
          b.week,
          b.datetime,
          ...
          b.score_fulltime_home AS home_goals,
          b.score_fulltime_away AS away_goals,
          ...
          CASE 
            WHEN b.score_fulltime_home IS NULL OR b.score_fulltime_away IS NULL THEN NULL
            WHEN b.score_fulltime_home >  b.score_fulltime_away THEN 1
            WHEN b.score_fulltime_home <  b.score_fulltime_away THEN -1
            ELSE 0
          END AS result,
