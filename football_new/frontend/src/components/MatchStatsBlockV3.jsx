...
const ROW = "py-2.5";
const GRID = "grid grid-cols-[140px_1fr_140px] items-center gap-4";
const VALUE = "text-[16px] font-medium text-white tabular-nums text-center";
const VALUE_AWAY = "text-[16px] font-medium text-white tabular-nums text-center";
const LABEL = "text-[13px] text-white/72 text-center leading-[1.15]";
