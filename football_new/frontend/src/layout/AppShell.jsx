...
import TopRatedPlayersCard from "@/components/TopRatedPlayersCard";
  ...
  return (
    ...
    >
      ...
      <header className="sticky top-0 z-50 border-b border-white/5 bg-black/10 backdrop-blur-2xl">
        <div className="max-w-[1600px] mx-auto px-4 pt-3 pb-3">
          <LeagueTabsHeader
            league={league}
            season={season}
      ...
      {/* GRID */}
      <div className="max-w-[1600px] mx-auto px-4 pb-10 mt-6 grid grid-cols-1 xl:grid-cols-[260px_minmax(0,1fr)_260px] gap-7">
        ...
        <aside className="hidden xl:block">
          <div className="sticky top-28 space-y-5">
            <div className="rounded-3xl border border-white/10 bg-white/[0.04] backdrop-blur-xl shadow-[0_8px_30px_rgba(0,0,0,0.45)] p-4">
              <TopRatedPlayersCard league={league} season={season} limit={3} />
            </div>
          </div>
        </aside>
      </div>
