...
const APP_AREAS = [
  ...
  },
  {
    title: "Аналитика",
    path: "/analytics",
    desc: "Раздел для анализа run-ов и лагов. Для ClickHouse показывает реальную работу и отдельно лаг ожидания.",
    useWhen: "Когда нужно понять, где длительность вызвана расчетом, а где ожиданием в очереди.",
  },
  {
    title: "Таблицы",
    path: "/tables",
  ...
  },
  {
    title: "Сущности",
    path: "/entities",
    desc: "Ландшафт сущностей, покрытие до DM и навигация по крупным бизнес-блокам.",
    useWhen: "Когда нужно смотреть систему сверху вниз, а не от конкретной таблицы.",
  },
  {
    title: "Медленные",
    path: "/slow-tables",
...
const USER_FLOWS = [
  ...
  },
  {
    ...
    steps: [
      "Откройте Аналитику и посмотрите работу и лаг отдельно.",
      ...
      <section className="cc-surface">
        ...
        <div className="onboarding-map-grid">
          ...
          <div className="onboarding-map-card">
            ...
            <div className="onboarding-map-text">
              Взаимные зависимости и циклы сущностей вынесены в нижнюю часть главной. Это не оперативный мониторинг, а диагностика устройства ландшафта.
            </div>
          </div>
          <div className="onboarding-map-card">
