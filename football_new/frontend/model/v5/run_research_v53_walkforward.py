...
OUTPUT_PATH = Path("tmp/outcome_v5_3_walkforward.json")
...
def main() -> None:
    ...
    while True:
        ...
        model_v50 = fit_catboost_v5(tr, cal)
        probs_v50 = predict_catboost_v5(model_v50, val)
        ...
        windows.append(
            {
                ...
                "overall": {
                    ...
                    "v5_0_catboost": evaluate_probs(val, probs_v50, "v5_0_catboost"),
