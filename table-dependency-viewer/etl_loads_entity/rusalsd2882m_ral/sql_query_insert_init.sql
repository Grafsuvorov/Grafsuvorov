...
(market,reg_perio,matkl,numvr,numlinevr,zakaz_kl,werks,vbeln_r,zperev,fact_date_z,potreb,buyer,
vbeln_ext,trader_buyer,locid,quota,inco2,kod_end_loc,end_loc,spec_order,bstkd,inco1,deliv_land,
potreb_land,werks_trade,sd_peretarka,ernam,zterm,paym_cond,deliv_region)
...
select
	...
	tech_etl.util_text_to_null_validation(rs."WERKS") as werks,					-- Завод
	...
	tech_etl.util_text_to_null_validation(rs."ERNAM") as ernam, -- Автор заказа ЦК из заявки
	tech_etl.util_text_to_null_validation(rs."ZTERM") as zterm,
	tech_etl.util_text_to_null_validation(rs."PAYM_COND") as paym_cond,
	tech_etl.util_text_to_null_validation(rs."DELIV_REGION") as deliv_region
